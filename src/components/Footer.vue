  ...
  <footer class="p-4 bg-white sm:p-6 dark:bg-gray-900 text-blue">
    <div class="md:flex mt-5">
      ...
      <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
        <div>
          <h2 class="mb-6 text-sm font-semibold uppercase">Producto</h2>
          <ul class="">
            <li class="mb-4">
              <a href="#como-funciona" class="hover:underline">Cómo Funciona</a>
            </li>
            <li class="mb-4">
              <a href="#por-que" class="hover:underline">¿Por qué?</a>
            </li>
            <li>
              <a href="#precios" class="hover:underline">Precios</a>
            </li>
          </ul>
        </div>
        <div>
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
      <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://rendilo.com/" class="hover:underline">Rendilo</a>. All Rights Reserved. </span>
