  ...
  <div class="bg-[#F9F7F3] items-center flex flex-col w-screen sm:pt-20">
    ...
    <div class="flex flex-col sm:grid sm:grid-cols-2 w-9/12 gap-5 mb-5">
      <div class="bg-[#EFEFEF] rounded-lg flex flex-col items-center py-4">
        ...
        <a class="text-xs w-96 px-7 mt-2 font-light text-center"
          >Administra tus pagos de manera eficiente, establece límites de gasto y controles de aprobación para tus pagos en tiempo real.</a
        >
        <img src="../assets/control.png" alt="finance" class="mt-8 w-72 rounded-lg border border-black" />
      </div>
      <div class="bg-[#EFEFEF] rounded-lg flex flex-col items-center py-4">
        <a class="text-lg font-medium">Almacena tus facturas en un solo lugar</a>
        <a class="text-xs w-96 px-7 mt-2 font-light text-center">Simplifica tus procesos contables y ahorra tiempo al administrar la recolección de tus facturas y recibos. </a>
    ...
    <div class="flex flex-col sm:grid sm:grid-cols-3 w-9/12 gap-5">
      <div class="bg-[#EFEFEF] rounded-lg flex flex-col items-center py-4">
        ...
        <a class="text-xs w-96 px-7 mt-2 font-light text-center"
          >Ahorra tiempo y evita errores al contabilizar automáticamente tus gastos. Simplifica tu proceso contable con una visión clara de tus finanzas.</a
        >
        <img src="../assets/cont.png" alt="finance" class="mt-8 h-64" />
      </div>
      <div class="bg-[#EFEFEF] rounded-lg flex flex-col items-center py-4">
        <a class="text-lg font-medium">Obten un mayor control financiero</a>
        <a class="text-xs w-96 px-7 mt-2 font-light text-center"
        ...
        <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          <div class="md:flex md:justify-between">
            ...
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              ...
              <div>
                <h2 class="mb-6 text-sm font-semibold text-[#1E1E1E] uppercase">Legal</h2>
                <ul class="text-gray-500 font-medium">
                  <li class="mb-4">
          ...
          <div class="sm:flex sm:items-center sm:justify-between">
            ...
            <div class="flex mt-4 sm:justify-center sm:mt-0">
              ...
              <a href="#" class="text-gray-500 hover:text-[#1E1E1E] ms-5">
